function projects() {
  return (
    <div className="md:flex mx-5  ">
      <section class="mx-8 text-gray-600 body-font">
        <div class="container  py-24 mx-auto">
          <div class="flex flex-wrap -m-4">
            <div class="p-4 bg-purple-100 border-2 rounded-lg border-purple-300">
              <div class="h-full bg-purple-100 bg-opacity-75 px-12 pt-12 pb-12 rounded-lg overflow-hidden text-center relative">
                ...
                <p class="leading-relaxed mb-3">
                  Generate/pick color with different shades for your next
                  project on the go
                </p>
          ...
          <div class="flex flex-wrap -m-4">
            <div class="p-4 bg-purple-100 border-2 rounded-lg border-purple-300">
              <div class="h-full bg-purple-100 bg-opacity-75 px-12 pt-12 pb-12 rounded-lg overflow-hidden text-center relative">
                ...
                {/* DESC OF PROJECT */}
                <p class="leading-relaxed mb-3">
                  A map based 'guide' for papular places (UK)
                </p>
                {/* TECHNOLOGIES / TECHS USED */}
                <div className="grid  grid-cols-3 gap-4 ">
                  <span class="text-xs font-medium bg-purple-200  py-2 -mx-1 rounded-3xl text-red-500 align-middle">
